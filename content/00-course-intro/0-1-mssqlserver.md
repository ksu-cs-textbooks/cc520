...
- We will be using two client tools throughout the semester. It is highly encouraged to also install a client on your own computer.
  - **VS Code** - Windows, macOS, or Linux: [https://code.visualstudio.com/](https://code.visualstudio.com/)
    ...
    - *Note:* I will also provide a pre-configured VS Code setup via GitHub.
  ...
  - **Azure Data Studio** - Windows, macOS, or Linux. This tool is shown frequently in my videos; however, I do not fully recommend it anymore as Microsoft is retiring the product end of February in favor of VS Code with extensions. [https://docs.microsoft.com/en-us/sql/azure-data-studio/download](https://docs.microsoft.com/en-us/sql/azure-data-studio/download)
...
If you are unable to install SQL Server on your own machine, you can use a GitHub Codespace that has SQL Server already installed. One will be provided by the end of the first week.

### Option 3: KSU CS Database Server
...
- Login: *Your eID*
- Password: *Will be provided as soon as I am given it by our IT folks*
